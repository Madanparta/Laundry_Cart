      ...
      <div className="washType_container">
        <img
          ...
          onClick={() => {
            productDispatcher({
              type: "wash",
              payload: { id: data.id, price: data.washing_types.wash.price },
            });
          }}
        />
        <img
          ...
          onClick={() => {
            productDispatcher({
              type: "press",
              payload: { id: data.id, price: data.washing_types.press.price },
            });
          }}
        />
        <img
          ...
          onClick={() => {
            productDispatcher({
              type: "fold",
              payload: { id: data.id, price: data.washing_types.fold.price },
            });
          }}
        />
        <img
          ...
          onClick={() => {
            productDispatcher({
              type: "pack",
              payload: { id: data.id, price: data.washing_types.pack.price },
            });
          }}
        />
      </div>
